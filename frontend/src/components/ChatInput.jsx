...
function ChatInput({ onSend }) {
    ...
    return (
        <footer className="border-t border-slate-200 bg-white p-4 transition-colors duration-300 dark:border-slate-700 dark:bg-slate-900">
            <form onSubmit={handleSubmit} className="mx-auto max-w-3xl">
                ...
                <textarea
                    ...
                    rows={1}
                    className="max-h-32 flex-1 resize-none bg-transparent text-slate-900 outline-none placeholder:text-slate-400 dark:text-white dark:placeholder:text-slate-500 cursor-pointer"
                />
            ...
            <p className="mx-auto mt-2 flex max-w-3xl items-center gap-1 text-xs text-gray-500 dark:text-slate-400">
                <Lock size={12} />
